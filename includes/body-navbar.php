	...
	<div id="#mainNavBar" class="container-fluid bg-warning">
		...
		<nav class="navbar navbar-expand-md navbar-light">
			...
			<div class="collapse navbar-collapse d-flex justify-content-around" id="principalNavBar">
				...
				<ul class="navbar-nav ml-auto">
					<?php if ( $auth->isLoged() ) : ?>
					<?php $theUser = $usersModel->getOneByEmail($_SESSION['email']); ?>
					<?php #echo '<pre>'; print_r($theUser); exit;echo '</pre>';?>
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="navBarMeMenu"
								role="button" data-toggle="dropdown"
								aria-haspopup="true" aria-expanded="false">
								<img src="admin/data/avatars/<?= $theUser->profile_image ?>" width="40" style="border-radius: 25%;">
								<?= $theUser->first_name ?>
							</a>
